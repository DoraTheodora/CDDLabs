...
{\em Semaphores, another important contribution by E. W. Dijkstra, can be viewed as an extension to mutex locks. ~\newline
 A semaphore is an object with two methods Wait and \hyperlink{class_signal}{Signal}, a private integer counter and a private queue (of threads). ~\newline
...
\hyperlink{}{\href{https://pages.mtu.edu/~shene/NSF-3/e-Book/SEMA/basics.html}{\tt https\+://pages.\+mtu.\+edu/$\sim$shene/\+N\+S\+F-\/3/e-\/\+Book/\+S\+E\+M\+A/basics.\+html} }}\begin{DoxyCompactItemize}
\item 
